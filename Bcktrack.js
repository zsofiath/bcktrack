    ...
    Bcktrack.prototype = {
        ...
        isArrayValidation: function(arr){
            if(!(arr instanceof Array )) {
                throw "Bad parameters:\n\tThe given tasks is expected to be an array, "+typeof tasks+ " is given."
            }
        },
        ...
        validateGivenParameters: function (tasks, currentPossibilityChecker, previousSolutionsChecker) {
            
            if(!(tasks instanceof Array )) {
                throw "Bad parameters:\n\tThe given tasks is expected to be an array, "+typeof tasks+ " is given."
            } else {
                tasks.forEach(function(element){
                    if(!element.possibilities){
                        throw "You havent specified the possible solutions for all the tasks. ";
                    } else {
                        if(!(element.possibilities instanceof Array)){
                            throw "The specified possibilities must be an array."
                        }
                    }
                })
            ...
            if(!(currentPossibilityChecker instanceof Function)) {
                throw "Bad parameters:"+"\n\tThe given currentPossibilityChecker is expected to be a Function, "+typeof currentPossibilityChecker+ " is given."
            }
            
            if(!(previousSolutionsChecker instanceof Function)) {
                throw "Bad parameters:"+"\n\tThe given previousSolutionsChecker is expected to be a Function, "+typeof previousSolutionsChecker+ " is given."
            }
        },
